...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, DTOParticipacionSubasta> ParticipacionSubastaConsumerFactory() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "Participacion-group"); // Puedes mantener el mismo groupId
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class);
        props.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest");

        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "com.subastapuja.Subasta_usuario.model.DTO.DTOParticipacionSubasta");
