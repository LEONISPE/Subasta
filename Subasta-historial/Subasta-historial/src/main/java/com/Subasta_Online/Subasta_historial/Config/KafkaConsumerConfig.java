...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, DTOiniciarSubasta> HistorialConsumerFactory() {
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "com.Subasta_Online.Subasta_historial.Model.DTOiniciarSubasta"); // <-- Asegúrate de cambiar esto con el path real de la clase
    ...
    public ConsumerFactory<String, DTOPujaActualizada> pujaActualizadaConsumerFactory() {
        ...
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class);
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "com.Subasta_Online.Subasta_historial.Model.DTOPujaActualizada"); // ⚠️ Asegúrate de que el path esté correcto
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "*");
        props.put(JsonDeserializer.USE_TYPE_INFO_HEADERS, false);
