...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, NotificacionDTO> notificationConsumerFactory() {
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "com.subastapuja.subasta.notificacion.model.NotificacionDTO");
    ...
    public ConsumerFactory<String, NotificacionSubastaProgramadaDTO> notificationConsumerFactorySubastaProgramada() {
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "com.subastapuja.subasta.notificacion.model.NotificacionSubastaProgramadaDTO");
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "*");
        props.put(JsonDeserializer.USE_TYPE_INFO_HEADERS, false);
